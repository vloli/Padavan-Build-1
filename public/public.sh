...
lan_ip="192.168.123"                                  # LAN 地址 别写后面的 .1
wlan_2g_ssid="AP"                              # 2G 无线名称
wlan_5g_ssid="AP_5G"                           # 5G 无线名称
wlan_guest_2g_ssid="AP_Guset"                  # 2G 访客无线名称
wlan_guest_5g_ssid="AP_Guest_5G"               # 5G 访客无线名称
